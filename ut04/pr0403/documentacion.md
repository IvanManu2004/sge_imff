...
for palabra in nombres:
    if(palabra.lower()[0:1] == "a" or palabra.lower()[0:1] == "á"):
        cuenta+=1
print(cuenta)
```
...
nombreBuscar = str(input("Introduce tu nombre: "))
if (nombres.count(nombreBuscar) > 0):
    print("Tu nombre es el numero " + str(nombres.index(nombreBuscar)))
else:
...
longitudDeseada = int(input("Introduce la longitud del nombre deseada: "))
contador = 0
for nombre in nombres:
    if(len(nombre) == longitudDeseada):
        contador += 1
...
for nombre in nombres:
    contador = 0
    while (contador < 25):
        letra = letras[contador]
        contadores[contador] += nombre.lower().count(letra)
        contador += 1

contador = 0
while (contador < 25):
    print(letras[contador] + " = " + str(contadores[contador]))
    contador += 1
```
...
### Ejercicio10
```
lista = ["palabra", "hola", "hola", "ola", "pelota", "mar", "sombrilla", "pelota", "caracola", "concha", "chancla", "rocas", "hola"]
palabraU = str(input("Introduce una palabra: "))
print("La palabra se repite " + str(lista.count(palabraU)) + " vece/s")
```
